...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Direct Model", subtitle: "Configure local or direct AI provider (Ollama, Groq, Gemini)", keywords: ["direct", "local", "ollama", "groq", "gemini", "api key", "base url", "bypass", "offline"], section: .advanced, advancedSubsection: .directModel, icon: "externaldrive.badge.icloud", settingId: "advanced.directmodel.config"),
        ...
        SettingsSearchItem(name: "Subscription", subtitle: "Manage your Fazm Pro subscription", keywords: ["subscription", "pro", "plan", "billing"], section: .about, advancedSubsection: nil, icon: "checkmark.seal.fill", settingId: "about.subscription"),
